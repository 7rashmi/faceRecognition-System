...
class Student:
    def __init__(self,root):
        ...
        main_frame.place(x=5,y=5,width=1500,height=650)

        #left label frame
        Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("times new roman",12,"bold"))
        Left_frame.place(x=10,y=10,width=760,height=580)

        img_left=Image.open(r"college_images\sdetials.jpg")
        ...
        #Course
        course_label=Label(current_course_frame,text="Course",textvariable=self.var_course,font=("times new roman",12,"bold"),bg="white")
        ...
        year_combo["values"]=("Select Year ","2023-2024","2024-2025","2025-2026","2026-2027")
        ...
        semester_combo["values"]=("Select Semester ","Semester1","Semester2","Semester3","Semester4")
       ...
       #Teacher Name
        ...
        img_right=Image.open(r"college_images\clg.jpg")
        ...
        scroll_y=ttk.Scrollbar(table_frame,orirnt=VERTICAL)
        ...
        self.student_table.heading("photo","PhotoSampleStatus")
        ...
        self.student_table.pack(fill=BOTH,expands=1)
         ...
         if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
             ...
             try:
                 ...
                 if Update>0:
                     conn=mysql.connector.connect(host="localhost",username="root",password="12345678",database="face_recognizer")
                     my_cursor=conn.cursor()
                     my_cursor.execute("update student set Dep=%s,Course=%s,Year=%s,Semester=%s,Name=%s,Division=%s,Roll=%s,Gender=%s,Dob=%s,Email=%s,Address=%s,Teacher=%s,PhotoSample=%s where Student_id=%s",(
    ...
    def reset_data(self):
        ...
        self.var_std_id.get("")
        self.var_std_name.get("")
        self.var_div.get("Select Division")
        self.var_roll.get("")
          ...
          if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
              ...
              try:
                  ...
                  for x in myresult:
                      ...
                      #========load predefiened data on face frontals from open cv======
