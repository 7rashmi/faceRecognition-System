...
class Attendance:
    def __init__(self,root):
        ...
        delete_btn=Button(btn_frame,text="Update",command=self.get_cursor,width=17,font=("times new roman",12,"bold"),bg="blue",fg="white")
        ...
        def fetchData(self,rows):
            self.AttendanceReportTable.delete(*self.AttendanceReportTable.get_childern())
            for i in rows:
