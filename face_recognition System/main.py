...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        #second img
        img1=Image.open(r"college_images\facialrecognition.jpg")
        ...
        title_lbl=Label(bg_img,text="FACE RECOGINITION ATTENDENCE SYSTEM SOFTWARE",font=("times new roman",35,"bold"),bg="white",fg="red")
        ...
        #student button
        img4=Image.open(r"college_images\studentdetails.jpg")
        ...
        b1_1=Button(bg_img,text="Student Detials",command=self.student_details ,cursor="hand2",font=("times new roman",15,"bold"),bg="darkblue",fg="white")
        b1_1.place(x=200,y=300,width=220,height=40)    

        #face detector button
        img5=Image.open(r"college_images\facedetector.jpg")
