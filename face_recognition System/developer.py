...
class Developer:
    def __init__(self,root):
        ...
        img_top1=Image.open(r"college_images\rashmi.jpg")
        ...
        f_lbl.place(x=300,y=0,width=200,height=200)
         ...
         #Developer info
        dev_label=Label(main_frame,text="Hello I'am Rashmi ",font=("times new roman",20,"bold"),bg="white")
        dev_label.place(x=0,y=5)
        
        dev_label=Label(main_frame,text="I am full Stack Developer ",font=("times new roman",20,"bold"),bg="white")
        dev_label.place(x=0,y=40)
        
        img2=Image.open(r"college_images\software.jpg") 
